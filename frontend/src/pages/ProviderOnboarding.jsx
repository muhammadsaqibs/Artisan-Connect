...
export default function ProviderOnboarding() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/categories").then((res) => setCategories(res.data.data || [])).catch(()=>{});
  }, []);
  ...
  const uploadImage = async (file, isCover = false) => {
    ...
    await axios.put("http://localhost:5000/api/providers/me", fd, { headers: { ...authHeaders, "Content-Type": "multipart/form-data" } });
  };
  ...
  const uploadDoc = async (file) => {
    ...
    await axios.post("http://localhost:5000/api/providers/me/documents", fd, { headers: { ...authHeaders, "Content-Type": "multipart/form-data" } });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put("http://localhost:5000/api/providers/me", payload, { headers: authHeaders });
